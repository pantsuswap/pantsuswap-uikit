...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputBorder: "#cccccc", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#d2cead", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#7f7d6b", background: "#525149", backgroundDisabled: "#7f7d6b", contrast: "#ffffff", invertedContrast: "#17150a", input: "#aba997", inputBorder: "#cccccc", primaryDark: "#d95b00", tertiary: "#aba997", text: "#FFFFFF", textDisabled: "#302f25", textSubtle: "#ffffff", borderColor: "#524B63", card: "#32322d", gradients: {
